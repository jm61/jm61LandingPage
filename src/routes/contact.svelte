...
<div>
    <form class="contactForm flex flex-col" on:submit|preventDefault={sendMessage}>
        ...
        <div class="form-control">
            ...
            <input type="text" placeholder="Type here" class="input input-bordered" name="user_name" required />
        </div>
        ...
        <div class="form-control">
            <label class="label" for="email">
              ...
              <input type="text" placeholder="email@mail.com" class="input input-bordered" name="user_email" required />
          </div>
