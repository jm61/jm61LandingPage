...
<div>
    <form class="contactForm flex flex-col" on:submit|preventDefault={sendMessage}>
        ...
        <div class="form-control">
            ...
            <input type="text" placeholder="Type here" class="input input-bordered" name="user_name" />
        </div>
        ...
        <div class="form-control">
            <label class="label" for="email">
              ...
              <input type="text" placeholder="email@mail.com" class="input input-bordered" name="user_email" />
          </div>
          ...
          <div class="form-control">
            ...
            <textarea name="message" class="textarea textarea-bordered h-24" placeholder="votre message"></textarea>
          </div>

          <div class="form-control">
              <label for="button" class="input-group mb-6"></label>
